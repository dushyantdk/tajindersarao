      ...
      <div class="row">
         ...
         <div class="col-xl-12 col-sm-12">
            <div class="block_title">
               <h4><strong>Step 1:</strong> Mortgage Application</h4>
            </div>
         ...
         <div class="col-xl-12 col-sm-12">
            <div class="block_title">
               <h4><strong>Step 2:</strong> Choose the Right Mortgage Program</h4>
            </div>
            <p>Like all homes, Canadian mortgages also come in all shapes and sizes. You have to pick which loan is more aligned with your financial situation and goals. There are four basic types of Canadian home financing loans.</p>
            <p class="text-bold">A) Fixed Rate Mortgage </p>
            <p>A Fixed Rate mortgage usually has terms that can last from 1 year to 10 years. As the name suggests, the interest rate and monthly payments will remain the same for the specified term.</p>
            ...
            <p class="text-bold">B) Adjustable Rate Mortgage </p>
            ...
            <p class="text-bold">C) Combination Rate Mortgage </p>
